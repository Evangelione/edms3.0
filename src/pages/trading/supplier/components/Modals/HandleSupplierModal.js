...
@Form.create()
class HandleSupplierModal extends Component {
  constructor(props) {
    super(props)
    this.state = {
      modalVisible: false,
  ...
  render() {
    ...
    return (
      <div style={{display: 'inline-block'}} onClick={this.openInsertModal}>
        {children}
        <Modal visible={modalVisible} title='新增供应商' width={600} bodyStyle={{padding: '24px 60px'}}
...
export default HandleSupplierModal
