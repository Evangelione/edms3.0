...
import { logisticsReconciliationHistoryColumns } from '@/common/tableColumns'
...
class Index extends Component {
  ...
  render() {
    ...
    const {reconciliationHistoryList, reconciliationHistoryPage, reconciliationHistoryTotal} = logistics
    return (
      <>
